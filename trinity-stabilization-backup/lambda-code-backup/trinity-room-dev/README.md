...
- **Timeout**: 30s
- **Memory**: 512MB
- **Última modificación**: 2026-01-26T23:48:40.000+0000
...
```bash
cd lambdas/trinity-room-dev
zip -r function.zip .
aws lambda update-function-code --function-name trinity-room-dev --zip-file fileb://function.zip --region eu-west-1
```
