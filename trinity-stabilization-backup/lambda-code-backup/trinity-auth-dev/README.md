...
- **Timeout**: 30s
- **Memory**: 512MB
- **Última modificación**: 2026-01-26T22:58:52.000+0000
...
```bash
cd lambdas/trinity-auth-dev
zip -r function.zip .
aws lambda update-function-code --function-name trinity-auth-dev --zip-file fileb://function.zip --region eu-west-1
```
